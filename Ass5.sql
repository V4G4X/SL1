...
SELECT SUM(Orders.ttl_amt) AS Total_Order_Value
FROM Orders;
...
5. Display the name of customers whose first name starts with “Rav”.
...
FROM Orders
WHERE ttl_amt = (SELECT MAX(Orders.ttl_amt)
FROM Orders));

7. Display order details of customer whose city name is “Pune” and purchase date is “2018-11-09”
...
8.
Add discount of 5% to all the customers whose order is more than Rs. 5000/-.
